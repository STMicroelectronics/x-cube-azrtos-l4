...
- When a cdc device is plugged to NUCLEO-L4R5ZI board, a Message will be displayed on the uart HyperTerminal (STlink VCP) showing
...
- NUCLEO-L4R5ZI Set-up
    - Plug the USB CDC_ACM device into the NUCLEO-L4R5ZI board through 'USB micro A-Male  to A-Female' cable to the connector:
