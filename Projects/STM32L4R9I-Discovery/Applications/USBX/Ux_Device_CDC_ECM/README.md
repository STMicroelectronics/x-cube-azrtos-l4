...
This application provides an example of Azure RTOS CDC_ECM stack usage on STM32L4R9I-Discovery board, it shows how to run Web HTTP server based application stack
