...
This application provides an example of Azure RTOS USBX stack usage on STM32L4R9I-Discovery board, it shows how to develop USB Device mass storage class based
...
When plugged to PC host, the STM32L4R9I-Discovery should enumerate as an USB MSC device. During the enumeration phase, device must provide host with the requested
...
Once the STM32L4R9I-Discovery USB device successfully completed the enumeration phase, a new removable drive appears in the system window and write/read/format
