...
This application provides an example of Azure RTOS USBX stack usage on STM32L4R9-Discovery board, it shows how to develop a composite USB Device communication
...
When plugged to PC host, the STM32L4R9-Discovery must be properly enumerated a composite device as an HID ,USB Serial device and an STlink Com port.
...
### <b>Hardware and Software environment</b>
  ...
  - STM32L4R9-Discovery Set-up:
    - Connect the STM32L4R9-Discovery board CN1 to the PC through "MICRO-USB" to "Standard A" cable.
