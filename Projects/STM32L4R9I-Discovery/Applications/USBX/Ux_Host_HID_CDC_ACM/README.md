...
This application provides an example of Azure RTOS USBX stack usage on STM32L4R9-Discovery.
...
### <b>Hardware and Software environment</b>
  ...
  - STM32L4R9-Discovery Set-up
    - Plug the USB CDC_ACM device into the STM32L4R9-Discovery board through 'USB micro A-Male  to A-Female' cable to the connector:
