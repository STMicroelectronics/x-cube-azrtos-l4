...
When a hid device plugged to STM32L4R9-Discovery board, a Message will be displayed on the uart HyperTerminal showing
...
When an usb flash disk is plugged to STM32L4R9-Discovery board, a Message will be displayed on the uart HyperTerminal showing  the Vendor ID and the Product ID of the attached device.
...
### <b>Hardware and Software environment</b>
  ...
  - STM32L4R9-Discovery Set-up
    - Plug the USB device (mouse, keyboard, flash disk) into the STM32L4R9-Discovery board through 'USB micro A-Male  to A-Female' cable to the connector:
      - CN9 : to use USB Full Speed OTG IP.
