...
int main(void)
{
  ...
  /* Application behavior changes depending from the state of the JOYSTICK:
     JOYSTICK pressed : enter the IAP mode
     JOYSTICK released: run the user application already programmed
  */
