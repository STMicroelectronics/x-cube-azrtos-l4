...
#define LX_STM32_OSPI_SECTOR_SIZE                  MX25LM51245G_SECTOR_SIZE
...
#define LX_STM32_OSPI_OCTAL_READ_STATUS_REG_CMD    OCTAL_READ_STATUS_REG_CMD
#define LX_STM32_OSPI_OCTAL_IO_DTR_READ_CMD        OCTAL_IO_DTR_READ_CMD
#define LX_STM32_OSPI_OCTAL_PAGE_PROG_CMD          OCTAL_PAGE_PROG_CMD
#define LX_STM32_OSPI_OCTAL_BULK_ERASE_CMD         OCTAL_CHIP_ERASE_CMD
#define LX_STM32_OSPI_OCTAL_SECTOR_ERASE_CMD       OCTAL_SECTOR_ERASE_CMD
#define LX_STM32_OSPI_OCTAL_WRITE_ENABLE_CMD       OCTAL_WRITE_ENABLE_CMD
#define LX_STM32_OSPI_OCTAL_READ_CFG_REG_2_CMD     OCTAL_READ_CFG_REG_2_CMD
#define LX_STM32_OSPI_OCTAL_WRITE_CFG_REG_2_CMD    OCTAL_WRITE_CFG_REG_2_CMD
#define LX_STM32_OSPI_RESET_ENABLE_CMD             RESET_ENABLE_CMD
#define LX_STM32_OSPI_READ_STATUS_REG_CMD          READ_STATUS_REG_CMD
#define LX_STM32_OSPI_WRITE_ENABLE_CMD             WRITE_ENABLE_CMD
#define LX_STM32_OSPI_WRITE_CFG_REG_2_CMD          WRITE_CFG_REG_2_CMD
#define LX_STM32_OSPI_READ_CFG_REG_2_CMD           READ_CFG_REG_2_CMD
