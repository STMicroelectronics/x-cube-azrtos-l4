...
This application provides an example of Azure RTOS FileX stack usage on STM32L4R9I-Discovery, it shows how to develop a basic SD card file
...
it will be overwritten. A short text string is then written into the file and it is closed. The file is opened once again in read mode and content
